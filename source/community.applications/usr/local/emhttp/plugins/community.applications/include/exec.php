...
$selectCategoryMessage = "Select a Section <i class='fa fa-bars enabledIcon' aria-hidden='true' style='font-size:20px;cursor:auto;'></i> or Category <i class='fa fa-folder enabledIcon' aria-hidden='true' style='font-size:20px;cursor:auto;'></i> above";
...
case 'convert_docker':
    ...
    $teststring = str_replace("\\"."\n"," ",$teststring);
		...
		$dockerfile['Icon'] = "https://github.com/limetech/webgui/raw/master/plugins/dynamix.docker.manager/images/question.png";
